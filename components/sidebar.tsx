...
export const Sidebar = () => {
  ...
  return (
    <>
      <aside className="h-screen px-1 pt-4 overflow-y-auto relative flex w-50 flex-col #f0f0f0 dark:bg-[#0F0F0F]">
        <div className="p-4 flex items-center justify-center font-semibold gap-2">
